    ...
    */
    ...
    for (var index = 0; index < count_num_cycles; index++) {
        ...
        do {
            ...
            console.log(audio_obj.buffer[running_index] , "theta ", theta);
...
// var pop_audio_buffer_custom = function (size_buff, given_samples_per_cycle) {
var pop_audio_buffer_custom = function (number_of_samples, given_freq, samples_per_second) {

// func Pop_audio_buffer(number_of_samples float64, given_freq float64, samples_per_second float64) ([]float64, error) {

    console.log("in pop_audio_buffer_custom "); 
    ...
    */
    ...
    console.log("given_freq ", given_freq);
    ...
    */
    ...
    console.log("incr_theta ", incr_theta);
...
exports.pop_audio_buffer_custom = pop_audio_buffer_custom;
